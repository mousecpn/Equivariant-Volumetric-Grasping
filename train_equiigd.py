...
def main(args):
    ...
    trainer = create_trainer(net, optimizer, None, metrics, device)
    evaluator = create_evaluator(net, None, metrics, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--net", default="equiigd")
    parser.add_argument("--dataset", type=Path, required=True)
    parser.add_argument("--dataset_raw", type=Path, required=True)
    parser.add_argument("--logdir", type=Path, default="data/equiigd_runs")
